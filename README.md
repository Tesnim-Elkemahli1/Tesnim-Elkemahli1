...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=280&color=gradient&customColorList=6,11,20,24,30&text=Tasnim%20El%20Kemahli&fontSize=55&fontColor=ffffff&animation=fadeIn&fontAlignY=40&desc=Computer%20Engineering%20Graduate%20%7C%20Software%20Developer&descAlignY=58"/>
...
<a href="mailto:tesnimelkemahli1@gmail.com">
...
<img src="https://skillicons.dev/icons?i=c,cpp,cs,java,python,html,css,js,bootstrap,mysql,git,github,vscode,visualstudio"/>
...
| 🌐 Web Development | ⚙️ Backend | 🗄️ Databases | 🧠 Problem Solving |
|:------------------:|:----------:|:------------:|:------------------:|
| HTML • CSS • JS | C# • Java • Python | MySQL | Algorithms & Logic |
...
|:---------:|:--------------|:--------|
| 🌐 Portfolio Website | Personal portfolio showcasing my work | HTML • CSS • JavaScript |
| 📚 Student Management System | Manage students, courses, and grades | C# • SQL Server |
| 🛒 E-Commerce Website | Online shopping platform | HTML • CSS • JavaScript • MySQL |
| 📱 Coming Soon... | More exciting projects are on the way! | 🚀 |
...
<img src="https://readme-typing-svg.demolab.com?font=Poppins&size=24&duration=3500&pause=1000&color=C77DFF&center=true&vCenter=true&width=700&lines=Thanks+for+visiting!;Let's+build+something+amazing!;Happy+Coding!+💜"/>
